...
namespace Xynapse.UI {
    public abstract class Drawable {
        ...
        public void Draw(DrawContext context, FxVector position, FxVector? align = null, PxRect? sampleRect = null, DrawColor? color = null, float rotation = 0, float scale = 1f) {
